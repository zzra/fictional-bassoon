...
/** Code Behind for editing items you wear on your head
 *
...
public class EditHead extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_edit_head);
        ...
        outfitItems = db.getItemsForPosition(0);
